"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for codon-optimization-species-agent.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Codon Optimization Species Agent"):
